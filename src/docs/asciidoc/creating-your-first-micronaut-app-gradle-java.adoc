...
`mn create-app example.micronaut.complete --build=gradle --lang=java`
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-java/src/main/Java/example/micronaut/Application.java[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-java/src/main/Java/example/micronaut/HelloController.java[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-java/src/test/Java/example/micronaut/HelloControllerTest.java[]
----
