...
`mn create-app example.micronaut.complete --build=maven --lang=java`
...
----
include::{sourceDir}/creating-your-first-micronaut-app-maven-java/src/main/Java/example/micronaut/Application.java[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-maven-java/src/main/Java/example/micronaut/HelloController.java[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-maven-java/src/test/Java/example/micronaut/HelloControllerTest.java[]
----
