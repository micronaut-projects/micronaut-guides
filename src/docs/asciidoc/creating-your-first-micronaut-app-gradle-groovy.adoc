...
`mn create-app example.micronaut.complete --build=gradle --lang=groovy`
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-groovy/src/main/Groovy/example/micronaut/Application.groovy[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-groovy/src/main/Groovy/example/micronaut/HelloController.groovy[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-groovy/src/test/Groovy/example/micronaut/HelloControllerSpec.groovy[]
----
