...
`mn create-app example.micronaut.complete --build=gradle --lang=kotlin`
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-kotlin/src/main/Kotlin/example/micronaut/Application.kt[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-kotlin/src/main/Kotlin/example/micronaut/HelloController.kt[]
----
...
----
include::{sourceDir}/creating-your-first-micronaut-app-gradle-kotlin/src/test/Kotlin/example/micronaut/HelloControllerTest.kt[]
----
