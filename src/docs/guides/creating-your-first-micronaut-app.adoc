...
[source,@lang@]
.src/main/@lang@/example/micronaut/Application.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/Application.@languageextension@[]
----
...
[source,@lang@]
.src/main/@lang@/example/micronaut/HelloController.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/HelloController.@languageextension@[]
----
...
[source,@lang@]
.src/test/@lang@/example/micronaut/HelloControllerTest.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/test/@lang@/example/micronaut/HelloController@testsuffix@.@languageextension@[]
----
