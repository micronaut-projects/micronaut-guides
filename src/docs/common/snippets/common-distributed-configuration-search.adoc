...
If your application has the https://micronaut-projects.github.io/micronaut-core/latest/guide/#environments[active environments] `ec2`, `cloud`, and `lambda`, the following configuration prefixes are searched:
