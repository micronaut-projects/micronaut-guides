...
Find the https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/compartment/list.html[OCID of the compartment] where we'll be deploying. Run this to list all the compartments in your root compartment:
