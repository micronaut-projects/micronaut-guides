...
https://micronaut-projects.github.io/micronaut-openapi/latest/guide/#micronautOpenApiAnnotations[Micronaut OpenAPI annotations] as a compile-only dependency:
