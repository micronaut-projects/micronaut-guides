...
resource:application.toml[tag=webjars]
:exclude-for-languages:
...
Create a controller that renders a https://micronaut-projects.github.io/micronaut-views/latest/guide[View].
...
Go to http://localhost:8080, enter your name, and click the button. You will see a message in the console:
