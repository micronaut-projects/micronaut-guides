...
import org.assertj.core.api.AssertionsForClassTypes.catchThrowableOfType
import org.junit.jupiter.api.Test

@Sql(value = ["classpath:schema.sql", "classpath:data.sql"]) // <1>
@MicronautTest // <2>
class SaasSubscriptionControllerGetTest(@Client("/") private val httpClient: HttpClient) { // <3>
    ...
    fun shouldNotReturnASaasSubscriptionWithAnUnknownId() {
        val client = httpClient.toBlocking()
        val thrown = catchThrowableOfType({ // <4>
