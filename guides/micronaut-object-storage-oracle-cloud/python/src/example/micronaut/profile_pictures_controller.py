...
from micronaut.objectstorage.oraclecloud import (
...
class ProfilePicturesController:
    ...
    def __init__(
        self,
        object_storage: OracleCloudStorageOperations,  # <3>
...
# end::begin-class[]
    ...
    @staticmethod
    def build_streamed_file(entry: OracleCloudStorageEntry) -> HttpResponse[StreamedFile]:
        native_entry = entry.getNativeEntry()
        media_type = MediaType.of(native_entry.getContentType())
