...
After creating the repository, go to _Account Settings / Personal Access Tokens_ and https://app.docker.com/settings/personal-access-tokens[Generate an access token] with scope `Read, Write`.
