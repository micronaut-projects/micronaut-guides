...
https://www.openapis.org[OpenAPI] is a specification for describing REST APIs. Many web APIs provide definitions for the available endpoints and parameters in the form of OpenAPI documents. OpenAPI infrastructure includes numerous tools, including the OpenAPI generator.
...
If you want to learn about the structure of an OpenAPI specification and how to simplify the creation of a Micronaut server
...
* generate a server API based on the definitions.
