...
<2> callout:turbostream-fluid-api[]
...
<1> callout:application-event-publisher[arg0=RoomMessage]
...
<1> callout:websocket-server[]
<2> callout:websocket-broadcaster[]
<3> callout:websocket-on-open[]
<4> callout:websocket-on-message[]
<5> callout:websocket-on-close[]
<6> callout:turbostream-fluid-api[]
...
resource:application.properties[tag=datasource,app=initial]
...
resource:application.properties[tag=flyway,app=initial]
...
<1> callout:jdbcrepository[]
<2> callout:crudrepository[]
<3> callout:join-left-fetch[arg0=messages]
...
<1> callout:default-implementation[]
<2> callout:valid[]

source:services/DefaultMessageService[app=initial]

<1> callout:singleton[]
<2> callout:application-event-publisher[arg0=RoomMessage]
...
resource:application.properties[tag=static-resources,app=initial]
...
<1> callout:controller[arg0=/rooms]
<2> callout:constructor-di[arg0=RoomRepository]
<3> callout:executes-on[]
<4> callout:view[]
<5> callout:get-generic[]
<6> callout:produces-html[]
...
<5> callout:consumes[]
<6> callout:post-generic[]
<7> callout:body-qualifier[]
...
<2> callout:controller[arg0=/rooms]
<3> callout:constructor-di[arg0=MessageService]
<4> callout:view[]
<5> callout:produces-html[]
<6> callout:get-generic[]
<7> callout:pathvariable[]
