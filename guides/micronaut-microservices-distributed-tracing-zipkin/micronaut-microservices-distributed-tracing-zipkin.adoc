...
Append to `bookinventory` service `application.properties` the following snippet:
...
Append to `bookrecommendation` service `application.properties` the following snippet:
