...
To learn more about this sample application read https://guides.micronaut.io/latest/micronaut-microservices-services-discover-consul-@build@-@lang@.html[Consul and Micronaut - Microservices service discovery] guide. The application contains three microservices.
