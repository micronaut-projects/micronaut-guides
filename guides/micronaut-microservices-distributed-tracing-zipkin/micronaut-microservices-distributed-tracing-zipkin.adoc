...
To learn more about this sample application read https://guides.micronaut.io/latest/micronaut-microservices-services-discover-consul-@build@-@lang@.html[Consul and Micronaut Framework - Microservices service discovery] guide. The application contains three microservices.
...
== Zipkin and Micronaut Framework
...
The Micronaut framework includes several annotations to give you more flexibility. We introduced the `@ContinueSpan`, `@SpanTag` annotations.
...
Make sure to read more about https://docs.micronaut.io/latest/guide/index.html#zipkin[Tracing with Zipkin] in the Micronaut framework.
