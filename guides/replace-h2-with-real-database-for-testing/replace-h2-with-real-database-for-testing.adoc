...
== Summary
We have looked at how to test Micronaut Data JPA repositories using the https://www.h2database.com/html/main.html[H2] in-memory database and talked about
