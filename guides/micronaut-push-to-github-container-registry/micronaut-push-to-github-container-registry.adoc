...
image-name = "ghcr.io/githubOrganizationOrUsername/micronautguide"
----
...
[source,bash]
----
echo "${GITHUB_PERSONAL_ACCESS_TOKEN}" | docker login ghcr.io -u githubOrganizationOrUsername --password-stdin
----
...
docker push ghcr.io/githubOrganizationOrUsername/micronautguide:1.0.0
----
