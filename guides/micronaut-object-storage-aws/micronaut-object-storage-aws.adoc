...
Then, configure the bucket in your application configuration:
...
resource:application.toml[tag=object-storage]
:exclude-for-languages:
...
callout:executes-on[]
callout:object-storage-operations[arg0=aws,arg1=AwsS3Operations]
...
callout:object-storage-upload-response[arg0=https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/services/s3/model/PutObjectResponse.html,arg1=PutObjectResponse]
<.> The upload can be customised by using Amazon's https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/services/s3/model/PutObjectRequest.Builder.html[PutObjectRequest.Builder] methods.
...
<.> The retrieve operation returns an `ObjectStorageEntry`, in this case an
...
callout:object-storage-entry-to-response[arg0=AwsS3ObjectStorageEntry]
