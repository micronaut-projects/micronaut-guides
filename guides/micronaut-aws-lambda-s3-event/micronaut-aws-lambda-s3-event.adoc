...
<2> callout:configuration-properties-constraints[]
...
<1> callout:singleton[]
<2> callout:constructor-di[arg0=ThumbnailConfiguration]
...
<2> callout:injection[arg0=S3Client]
<3> callout:injection[arg0=ThumbnailGenerator]
