...
<2> callout:constructor-di[arg0=RobotFather]
<3> callout:constructor-di[arg0=RobotMother]
<4> callout:get[arg0=children,arg1=/]
...
<1> callout:singleton[]
<2> callout:constructor-di[arg0=Robot]
...
<1> callout:request-scope[]
<2> callout:request-aware[]
...
<1> callout:context[]
<2> callout:configuration-properties[]
