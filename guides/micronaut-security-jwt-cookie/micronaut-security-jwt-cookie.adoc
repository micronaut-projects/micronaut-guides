...
Add a dependency for Micronaut JWT security:
...
Add a dependency for the Micronaut https://docs.micronaut.io/latest/guide/index.html#views[Server Side View Rendering Module] and for Velocity:
