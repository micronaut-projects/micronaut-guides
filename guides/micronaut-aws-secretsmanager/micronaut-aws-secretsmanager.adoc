...
OAuth 2.0 clients have a client ID and secret property. You will save both in AWS Secrets Manager.
...
Create a controller that exposes the value read from AWS Secrets Manager.
