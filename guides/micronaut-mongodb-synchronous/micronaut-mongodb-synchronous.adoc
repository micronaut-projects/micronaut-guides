...
Create a configuration object to encapsulate the MongoDB database's name and collection's name.
...
callout:constructor-di[number=2,arg0=MongoDbClient]
...
It registers a blocking https://mongodb.github.io/mongo-java-driver/4.0/apidocs/com/mongodb/client/MongoClient.html[MongoClient] which you can inject in other Micronaut beans as illustrated in the above code sample. 
