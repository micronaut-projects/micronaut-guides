...
<3> callout:constructor-di[arg0=FruitRepository]
<4> callout:get[arg0=list,arg1=/fruits]
<5> callout:post[arg0=save,arg1=/fruits]
<6> callout:at-status[]
<7> callout:valid[]
...
<1> callout:singleton[]
<2> callout:constructor-di[arg0=MongoDbConfiguration]
<3> callout:constructor-di[arg0=MongoDbClient]
