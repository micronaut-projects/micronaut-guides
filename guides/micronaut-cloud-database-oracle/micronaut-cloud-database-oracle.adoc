...
Find the https://docs.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/availability-domain/list.html[availabilty domain] where the database will be created. Run this to list the available domains in your compartment:
