...
In the "configuration" block of the "micronaut-maven-plugin" plugin in your `pom.xml`, change the base image to `frolvlad/alpine-glibc:alpine-3.12` in a new `baseImageRun` element:
