...
If you use https://launch.micronaut.io[Micronaut Launch], select "Micronaut Application" as application type, JDK version 17 or higher, and add the `oracle-function`, `oracle-cloud-sdk`, and `graalvm` features.
