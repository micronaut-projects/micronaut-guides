...
@Singleton // <1>
open class FruitRepositoryImpl(
    @Inject val rootProvider: RootProvider<FruitContainer> // <2>
): FruitRepository {

    override fun list() = rootProvider.root().fruits.values // <3>

    override fun create(fruit: FruitCommand): Fruit {
    ...
    override fun update(fruit: FruitCommand): Fruit? {
    ...
    override fun delete(fruit: FruitCommand) {
        performDelete(fruit)
    }
