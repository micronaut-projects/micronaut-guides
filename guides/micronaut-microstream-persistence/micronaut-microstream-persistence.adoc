...
Add the following snippet to `application.properties` to configure MicroStream.


resource:application.properties[tag=microstream]
...
<1> callout:singleton[]
<2> callout:constructor-di[arg0=RootProvider]
...
<1> callout:controller[arg0=/fruits]
<2> callout:constructor-di[arg0=FruitRepository]
<3> callout:get[arg0=list,arg1=/fruits]
<4> callout:post[arg0=save,arg1=/fruits]
<5> You can specify the HTTP status code via the `@Status` annotation.
<6> callout:valid[]
<7> callout:get[arg0=find,arg1=/fruits/\{name\}]
...
<1> callout:test-instance-per-class[]
<2> callout:http-client[]
