...
https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/group/create.html[Create a group] by running:
...
https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/user/create.html[Create a user] by running:
...
https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/group/add-user.html[Add the user to the group] by running:
...
Find the https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/compartment/list.html[OCID of the compartment] where the IAM policy will be created. Run this to list the compartments in your root compartment:
...
https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/iam/policy/create.html[Create an IAM policy] to grant members of the group permission to send emails:
...
https://docs.oracle.com/en-us/iaas/tools/oci-cli/2.10.4/oci_cli_docs/cmdref/email/sender/create.html[Create an email sender] by running:
