...
<3> callout:constructor-di[arg0=ProductRepository]
<4> callout:kafka-topic-listener[]
<5> callout:kafka-listener-offset-reset-earliest[]
...
<1> callout:kafka-client.adoc[1]
<2> callout:kafka-topic-publisher.adoc[2]
<3> callout:kafka-key.adoc[3]
...
<4> callout:test-containers-disabled-without-docker[]
<5> callout:test-instance-per-class[]
<6> callout:test-property-provider[]
