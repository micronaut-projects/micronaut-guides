...
<1> callout:rest-controller[]
<2> callout:autowired[arg0=BookRepository]
<3> callout:get-mapping[arg0=/books,arg1=list]
...
<2> callout:spring-boot-local-server-port[]
<3> callout:autowired[arg0=TestRestTemplate]
<4> callout:autowired[arg0=BookRepository]
