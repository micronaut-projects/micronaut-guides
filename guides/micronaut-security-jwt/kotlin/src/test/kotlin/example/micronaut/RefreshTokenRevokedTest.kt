...
internal class RefreshTokenRevokedTest {
    ...
    var client = embeddedServer.applicationContext.createBean(
        HttpClient::class.java, embeddedServer.url
    )
    var refreshTokenGenerator = embeddedServer.applicationContext.getBean(
        RefreshTokenGenerator::class.java
    )
    var refreshTokenRepository = embeddedServer.applicationContext.getBean(
