...
Copy the `ChannelPoolListener` class you created in the `bookcatalogue` microservice to `bookinventory/src/main/@lang@/example/micronaut/bookinventory`.
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
Copy the `ChannelPoolListener` class you created in the `bookcatalogue` microservice to `bookinventory/src/example/micronaut`.
:exclude-for-languages:
...
:exclude-for-languages:python
Copy the `ChannelPoolListener` class you created in the `bookcatalogue` microservice to `bookrecommendation/src/main/@lang@/example/micronaut/bookrecommendation`.
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
Copy the `ChannelPoolListener` class you created in the `bookcatalogue` microservice to `bookrecommendation/src/example/micronaut`.
:exclude-for-languages:
...
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
<1> Inject the RabbitMQ clients.
<2> Expose a route that returns the book recommendations.
:exclude-for-languages:
...
As <<test-resources,mentioned above>>, a shared dockerized instance of RabbitMQ will be started automatically when you run the application. If you want to start your own instance of RabbitMQ, you have a few options:
...
:exclude-for-languages:python
resource:application.properties[app=bookinventory,tag=port]
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
resource:application.toml[app=bookinventory,tag=port]
:exclude-for-languages:
...
:exclude-for-languages:python
resource:application.properties[app=bookcatalogue,tag=port]
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
resource:application.toml[app=bookcatalogue,tag=port]
:exclude-for-languages:
...
:exclude-for-languages:python
resource:application.properties[app=bookrecommendation,tag=port]
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
resource:application.toml[app=bookrecommendation,tag=port]
:exclude-for-languages:
