...
* The class is defined as a controller with the @api@/io/micronaut/http/annotation/Controller.html[@Controller] annotation mapped to the path `/micronautguide`
* The @api@/io/micronaut/http/annotation/Get.html[@Get] annotation is used to map the `index` method to all requests that use an HTTP GET.
...
* The @api@/io/micronaut/http/annotation/Post.html[@Post] annotation is used to map the `postMethod` method to all requests that use an HTTP GET.
