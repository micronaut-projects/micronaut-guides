...
In this guide, we are going to deploy a Micronaut function written in @language@ as a GraalVM Native image to a AWS Lambda custom runtime.
...
image::lambda-custom-runtime-bookrequest-handler[]
