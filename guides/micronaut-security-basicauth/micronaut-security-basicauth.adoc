...
Add the Micronaut security dependency to your build:
...
<1> To register a Singleton in the application context, annotate your class with `jakarta.inject.Singleton`
...
<1> Annotate the class with `@MicronautTest` to let the Micronaut framework start the embedded server and inject the beans. More info: https://micronaut-projects.github.io/micronaut-test/latest/guide/index.html[https://micronaut-projects.github.io/micronaut-test/latest/guide/].
...
If you open `localhost:8080` in a browser, a login dialog pops up due to the `WWW-Authenticate` header.
...
See the https://micronaut-projects.github.io/micronaut-security/latest/guide/index.html[Micronaut security documentation] to learn more.
