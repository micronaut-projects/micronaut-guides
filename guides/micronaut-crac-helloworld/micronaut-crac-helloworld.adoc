...
It has a transitive dependency on https://github.com/CRaC/org.crac[org.crac:crac].
...
To ease testing and development in operating systems that don't support CRaC, Micronaut CRaC includes the https://micronaut-projects.github.io/micronaut-crac/latest/guide/#checkpointSimulator[`CheckpointSimulator` API].
