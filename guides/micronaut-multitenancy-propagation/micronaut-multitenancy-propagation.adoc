...
Create a https://docs.micronaut.io/snapshot/guide/#clientAnnotation[declarative HTTP client]:
...
Read more about https://docs.micronaut.io/snapshot/guide/#multitenancy[Multitenancy] support in Micronaut framework and https://gorm.grails.org/latest/hibernate/manual/#multiTenancy[GORM Multitenancy support].
