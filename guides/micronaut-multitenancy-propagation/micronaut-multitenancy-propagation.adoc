...
dependency:geb-spock:3.4[groupId=org.gebish,scope=testImplementation]
dependency:htmlunit-driver:2.35.1[groupId=org.seleniumhq.selenium,scope=testCompile]
dependency:htmlunit:2.35.0[groupId=net.sourceforge.htmlunit,scope=testRuntime]
dependency:selenium-support:3.141.59[groupId=org.seleniumhq.selenium,scope=testImplementation]
...
dependency:micronaut-multitenancy[app=books]
dependency:micronaut-multitenancy-gorm[groupId=io.micronaut.groovy,app=books]
