...
To use Micronaut's multitenancy capabilities, you must have the multitenancy dependency in your build:
...
https://gorm.grails.org[GORM] is a powerful Groovy-based data access toolkit for the JVM. To use it in Micronaut, add the following dependencies:
