...
<2> To register a Singleton in the application context, annotate your class with `javax.inject.Singleton`.
...
Read more about https://docs.micronaut.io/snapshot/guide/index.html#multitenancy[Multitenancy] support in Micronaut framework and https://gorm.grails.org/latest/hibernate/manual/index.html#multiTenancy[GORM Multitenancy support].
