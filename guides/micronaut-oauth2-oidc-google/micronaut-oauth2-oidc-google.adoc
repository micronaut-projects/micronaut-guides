...
<2> You can choose any name. The name you select will be used in your routes. For example, if you set `google`, the login route for this OAuth 2.0 client is `/oauth/login/google`.
...
:exclude-for-languages:java,groovy,kotlin
Add to `config/application.toml`
