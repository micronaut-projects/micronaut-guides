...
<.> Once validated, we will save the ID Token in a Cookie. To read in subsequent requests, set `micronaut.security.authentication` to `cookie`.
...
<.> Map manually the GitHub https://tools.ietf.org/html/rfc6749#section-3.1[Authorization endpoint].
<.> Map manually the Github https://tools.ietf.org/html/rfc6749#section-3.2[Token endpoint].
