...
You are going to deploy a https://www.graalvm.org/reference-manual/native-image/[GraalVM Native Image] of  Micronaut application to https://cloud.google.com/run[Google Cloud Run].
...
Before attempting to push the image, make sure to run GraalVM JDK.
