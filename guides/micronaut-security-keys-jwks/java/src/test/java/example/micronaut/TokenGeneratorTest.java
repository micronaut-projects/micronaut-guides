...
public class TokenGeneratorTest {
    ...
    @Test
    void canGenerateSignedJsonWebTokens() throws ParseException {
        ...
        Assertions.assertEquals(1, jwt.getJWTClaimsSet().getClaims().keySet().size());
        Assertions.assertEquals("sergio", jwt.getJWTClaimsSet().getSubject());
    }
}
