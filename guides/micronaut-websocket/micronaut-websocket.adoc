...
<2> callout:constructor-di[arg0=ChatServerWebSocket]
...
<5> callout:websocket-on-message[]
<6> callout:websocket-on-close[]
...
<3> callout:websocket-client[]
<4> callout:websocket-client-autocloseable[]
<5> callout:websocket-on-message[]
...
<7> callout:websocket-client-connect[]
<8> Set up WebSocket clients for multiple users
<9> callout:awaitility[]
