...
With almost everything in place, you can start the application and try it out. First, set environment variables to configure the application data source. Then you can start the app.
...
After you finish this guide, you can stop and delete the AWS resources created to avoid incurring unnecessary charges.
