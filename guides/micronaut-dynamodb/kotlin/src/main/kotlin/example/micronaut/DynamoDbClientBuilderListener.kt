...
class DynamoDbClientBuilderListener(
    ...
    private val fakeAccessKeyId = "fakeMyKeyId"
    private val fakeSecretAccessKey = "fakeSecretAccessKey"
        ...
        event.bean
            ...
            .credentialsProvider {
                object : AwsCredentials {
                    override fun accessKeyId(): String = fakeAccessKeyId

                    override fun secretAccessKey(): String = fakeSecretAccessKey
                }
            }
}
