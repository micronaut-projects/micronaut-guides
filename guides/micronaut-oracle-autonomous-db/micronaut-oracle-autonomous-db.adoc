...
* https://docs.cloud.oracle.com/en-us/iaas/Content/API/SDKDocs/cliinstall.htm[Oracle Cloud CLI] installed, with local access to Oracle Cloud configured by running `oci setup config`. More about the configuration you can find at https://micronaut-projects.github.io/micronaut-oracle-cloud/snapshot/guide/[Micronaut Oracle cloud].
