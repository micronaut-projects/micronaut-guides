...
The main difference from the Spring Boot test is that you use the https://docs.micronaut.io/4.4.6/guide/#httpClient[Micronaut HTTP Client] to test the embedded server.
