...
<4> The @Get annotation maps the index method to all requests that use an HTTP GET to `/vat`
...
Run the application and you should be able to execute `curl -i localhost:8080/vat` and see `7.7`.

== Next steps

Read about Micronaut https://micronaut-projects.github.io/micronaut-aws/latest/guide/index.html#parametersStore[AWS Parameter Store] integration.
