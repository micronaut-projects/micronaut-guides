...
<1> callout:controller[arg0=/genres]
<2> callout:constructor-di[arg0=GenreRepository]
<3> callout:get[arg0=show,arg1=/{id}]
...
<11> callout:delete[arg0=delete,arg1=/genres/{id}]
<12> callout:at-status[]
