...
In this guide we will create cluster with name `micronaut-k8s` and we will use 2x `n1-standard-2` instances for GKE nodes. Everything will be deployed on your default Google Cloud region. You can check your default region by running:
