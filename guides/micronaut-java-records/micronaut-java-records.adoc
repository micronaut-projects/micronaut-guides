...
NOTE: To use Java records, specify JDK 17 or higher (e.g JDK 21,Jdk 25) when you create the application.
...
<.> Respond a Java Record and the application responds JSON representation of the object
