...
<1> callout:property[]
<2> callout:micronaut-test-start-application-false[]
...
<2> callout:constructor-di[arg0=BookRepository]
...
<1> callout:property[]
<2> callout:micronaut-test-transactional-false[]
