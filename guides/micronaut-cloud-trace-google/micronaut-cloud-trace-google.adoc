...
Using Micronaut CLI or Launch to create your application, the OpenTelemetry exporter will be added to your `application.yml` configurations.
...
If your traces aren't displayed yet, give it a moment. It takes a few seconds for the traces to show up in the console.
