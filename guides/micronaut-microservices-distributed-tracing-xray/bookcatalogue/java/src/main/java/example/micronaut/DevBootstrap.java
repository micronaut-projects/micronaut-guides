...
public class DevBootstrap implements ApplicationEventListener<StartupEvent> {
    ...
    private void seedData(){
        bookRepository.save(new Book(idGenerator.generate(), "1680502395", "Release It!"));
        bookRepository.save(new Book(idGenerator.generate(), "0321601912", "Continuous Delivery"));
        bookRepository.save(new Book(idGenerator.generate(), "1491950358", "Building Microservices"));
    }
}
