...
class BooksControllerTest implements TestPropertyProvider {
    ...
    void testRetrieveBooks() throws InterruptedException {
        ...
        Book continuousDelivery = new Book(idGenerator.generate(), "0321601912", "Continuous Delivery");
        bookRepository.save(continuousDelivery);
        Book buildingMicroservices = new Book(idGenerator.generate(), "1491950358", "Building Microservices");
