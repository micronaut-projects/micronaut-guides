...
<1> callout:spring-ann-component[]
<2> callout:spring-ann-configuration-properties[]
...
<1> callout:spring-ann-service[]
<2> callout:spring-at-validated[]
<3> callout:constructor-di[arg0=GreetingConfiguration]
...
<1> callout:spring-ann-restcontroller[]
<2> callout:constructor-di[arg0=GreetingService]
<3> callout:spring-ann-getmapping[]
<4> callout:spring-ann-requestparam[]
<5> callout:spring-ann-postmapping[]
<6> callout:spring-ann-requestbody[]
<7> callout:spring-ann-deletemapping[]
<8> callout:spring-response-entity[]
<9> callout:spring-ann-responsestatus[]
...
<1> callout:client-value-slash[]
<2> callout:spring-ann-getmapping[]
<3> callout:spring-ann-postmapping[]
<4> callout:spring-ann-requestbody[]
<5> callout:spring-ann-deletemapping[]
<6> callout:spring-ann-requestparam[]
...
<1> callout:spring-ann-component[]
<2> callout:constructor-di[arg0=GreetingService]
<3> callout:spring-ann-scheduled[]
