...
== Jaeger and Micronaut Framework
...
Make sure to read more about https://docs.micronaut.io/latest/guide/index.html#jaeger[Tracing with Jaeger] in the Micronaut framework.
