...
== Eureka and Micronaut Framework
...
Read more about https://docs.micronaut.io/latest/guide/index.html#serviceDiscoveryEureka[Eureka Support] in the Micronaut framework.
