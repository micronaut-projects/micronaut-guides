...
[source,bash]
----
mn create-app --features=discovery-eureka,graalvm example.micronaut.bookcatalogue --build=@build@ --lang=@lang@
----
...
[source,bash]
----
mn create-app --features=discovery-eureka,graalvm example.micronaut.bookinventory --build=@build@ --lang=@lang@
----
...
[source,bash]
----
mn create-app --features=discovery-eureka,reactor,graalvm example.micronaut.bookrecommendation --build=@build@ --lang=@lang@
----
