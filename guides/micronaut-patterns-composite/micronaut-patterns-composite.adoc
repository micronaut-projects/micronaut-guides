...
A common pattern while developing Micronaut applications is to create an ordered contract for a set of beans. Often, you want to evaluate every implementation in order.
...
Imagine you want to create an API to resolve a color with a functional interface:
:exclude-for-languages:

:exclude-for-languages:java,groovy,kotlin
Imagine you want to create an API to resolve a color with an abstract base class:
:exclude-for-languages:
...
:exclude-for-languages:
:exclude-for-languages:java,groovy,kotlin
<.> An abstract base class with one abstract method defines the color-fetching contract.
:exclude-for-languages:
callout:ordered[]
