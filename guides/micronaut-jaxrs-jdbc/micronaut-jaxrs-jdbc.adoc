...
//TODO replace this with a common:testAppWithTestResources.adoc[] which explains what's going on

common:testApp.adoc[]

//TODO replace this with a common:runapp-mysql-with-test-sources.adoc[]
