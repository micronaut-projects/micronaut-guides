...
In this sample application, we cache news headlines. Add https://micronaut-projects.github.io/micronaut-cache/latest/guide/index.html[Micronaut Caffeine Cache] dependency which adds support for cache using https://github.com/ben-manes/caffeine[Caffeine].
...
Read about Micronaut https://docs.micronaut.io/latest/guide/index.html#caching[Cache Advice].
