...
Read more about https://docs.micronaut.io/latest/guide/index.html#graal[GraalVM Support] inside the Micronaut framework.

Take a look at the https://github.com/micronaut-projects/micronaut-gradle-plugin[Micronaut Gradle plugin] and https://micronaut-projects.github.io/micronaut-maven-plugin/latest/index.html[Micronaut Maven Plugin] documentation.
