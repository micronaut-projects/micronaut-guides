...
If you use https://launch.micronaut.io[Micronaut Launch], select serverless function as the application type and add the `aws-lambda-scheduled-event` feature.
