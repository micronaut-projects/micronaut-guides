...
<1> callout:singleton[]
<2> callout:constructor-di[arg0=ApiKeyRepository]
...
<2> callout:produces[]
<3> callout:get[arg0=index,arg1=/]
<4> callout:secured-is-authenticated[]
<5> callout:principal[]
...
<1> callout:controller[arg0=/app]
<2> callout:produces[]
<3> callout:secured-is-authenticated[]
