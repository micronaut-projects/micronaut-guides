...
Define a bean of type https://micronaut-projects.github.io/micronaut-security/latest/api/io/micronaut/security/token/validator/TokenValidator.html[TokenValidator] to validate the API keys by using the `ApiKeyRepository`.
...
resource:application.toml[tag=apikeys]
