...
In this guide you will learn how to use Micronaut framework capabilities to schedule periodic tasks inside a Micronaut microservice.
...
INFO  example.micronaut.EmailUseCase - Sending email to ron@micronaut.example : Welcome to Micronaut Framework at 15/5/2018 06:26:34
----
