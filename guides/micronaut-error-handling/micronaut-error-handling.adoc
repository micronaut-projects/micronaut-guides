...
[source,@lang@]
.src/main/@lang@/example/micronaut/NotFoundController.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/NotFoundController.@languageextension@[]
----
...
.src/main/@lang@/example/micronaut/BookController.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/CommandBookSave.@languageextension@[]
----
...
[source,@lang@]
.src/main/@lang@/example/micronaut/MessageSource.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/MessageSource.@languageextension@[]
----
...
[source,@lang@]
.src/main/@lang@/example/micronaut/OutOfStockException.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/OutOfStockException.@languageextension@[]
----

Implement a ExceptionHandler; a generic hook for handling exceptions that occurs during the execution of an HTTP request.

[source,@lang@]
.src/main/@lang@/example/micronaut/OutOfStockExceptionHandler.@languageextension@
----
include::{sourceDir}/@sourceDir@/src/main/@lang@/example/micronaut/OutOfStockExceptionHandler.@languageextension@[]
----
