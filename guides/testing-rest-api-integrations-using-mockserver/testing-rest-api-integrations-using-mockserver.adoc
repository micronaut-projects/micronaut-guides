...
<1> callout:controller[arg0=/api]
<2> callout:constructor-di[arg0=PhotoServiceClient]
<3> callout:executes-on[]
<4> callout:get[arg0=getAlbumById,arg1=/albums/{albumId}]
<5> callout:pathvariable[]
...
<1> callout:test-containers-disabled-without-docker[]
...
<3> callout:test-containers-disabled-without-docker[]
<4> callout:test-property-provider[]
<5> We have registered the *"micronaut.http.services.photosapi.url"* property pointing to MockServer container endpoint.
<6> callout:injection-request-specification[]
<7> callout:rest-assured-spec-port[]
