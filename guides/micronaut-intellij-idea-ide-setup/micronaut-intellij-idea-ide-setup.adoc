...
== IntelliJ IDEA and Pyronaut

Pyronaut applications are Python projects configured through `pyproject.toml`. Open the generated project directory as a Python project and configure the Python interpreter used for Pyronaut development.

Run Pyronaut commands from the IDE terminal or from shell run configurations:
