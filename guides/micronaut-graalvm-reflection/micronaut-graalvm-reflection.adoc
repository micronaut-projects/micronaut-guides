...
<1> callout:controller[arg0=/transformer]
<2> callout:constructor-di[arg0=StringTransformer]
<3> callout:produces[]
<4> callout:query-value-server[arg0=q]
