...
**You can use https://www.graalvm.org/latest/reference-manual/native-image/dynamic-features/Reflection/[Reflection in Native Image]**. GraalVM analysis attempts automatic detection of reflection usage.
If automatic analysis fails, you can manually provide the program elements reflectively accessed at run time.
