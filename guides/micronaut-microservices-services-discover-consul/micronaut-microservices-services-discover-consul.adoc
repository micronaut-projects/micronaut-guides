...
<2> Configure the application to listen on port 8081
...
<2> Configure the application to listen on port 8082
...
<1> Configure the application name. The name will be used later in the guide.
<2> Configure the application to listen on port 8080
