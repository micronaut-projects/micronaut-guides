...
testResource:application-test.yml[app=bookcatalogue,tag=port]
...
testResource:application-test.yml[app=bookinventory,tag=port]
...
[source,@lang@]
.bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@
----
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@[tag=packageandimports]

include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@[tag=harcoded]
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@[tag=clazz]
----
...
.bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@
----
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=packageandimports]

include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=harcoded]
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=clazz]
----
...
testResource:application-test.yml[app=bookrecommendation,tag=port]
...
This configuration registers a Micronaut app with Consul with minimal configuration. Discover a more complete list of Configuration options at https://micronaut-projects.github.io/micronaut-discovery-client/latest/api/io/micronaut/discovery/consul/ConsulConfiguration.html[ConsulConfiguration].
...
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@[tag=consul]
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookCatalogueClient.@languageextension@[tag=clazz]
----
...
[source,@lang@]
.bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@
----
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=packageandimports]

include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=consul]
include::{sourceDir}/@sourceDir@/bookrecommendation/src/main/@lang@/example/micronaut/BookInventoryClient.@languageextension@[tag=clazz]
----
