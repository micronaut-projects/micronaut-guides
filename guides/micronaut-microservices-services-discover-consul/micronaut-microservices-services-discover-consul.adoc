...
== Consul and Micronaut Framework
...
Read more about https://docs.micronaut.io/latest/guide/index.html#distributedConfigurationConsul[Consul support] in the Micronaut framework.
