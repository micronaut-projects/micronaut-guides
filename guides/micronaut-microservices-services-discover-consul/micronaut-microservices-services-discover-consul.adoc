...
[source,bash]
----
mn create-app --features=discovery-consul,management,graalvm example.micronaut.bookcatalogue --build=@build@ --lang=@lang@
----
...
[source,bash]
----
mn create-app --features=discovery-consul,management,graalvm example.micronaut.bookinventory --build=@build@ --lang=@lang@
----
...
[source,bash]
----
mn create-app --features=discovery-consul,management,reactor,graalvm example.micronaut.bookrecommendation --build=@build@ --lang=@lang@
----
