...
creating an application with the CLI. For more information take a look https://micronaut-projects.github.io/micronaut-test/latest/guide/[at the documentation].
...
== RabbitMQ and Micronaut Framework
