...
https://dzone.com/articles/design-patterns-the-builder-pattern[DZone] article to learn more. Micronaut supports the Builder pattern with `@ConfigurationBuilder`.
